...
issueNumber: 2
date: '2026-08-04'
title: RAG Isn't Dead. Most People Just Don't Understand It.
subtitle: The technique isn't broken. Most implementations are.
excerpt: The technique isn't broken. Most implementations are.
heroImage: /assets/issue-2/1.jpg
topics:
  - AI
  - Machine Learning
  - RAG
...
sources:
  - title: Substack Dispatch
    ...
    date: '2026-08-04'
    url: 'https://xrcodex.substack.com/p/issue-2-rag-isnt-dead-most-people'
...
![RAG — Retrieval-Augmented Generation](/assets/issue-2/1.jpg)

People keep saying RAG is dead.

![The loud "RAG is dead" debate](/assets/issue-2/2.jpg)
...
![A librarian finding the right books in a vast library](/assets/issue-2/3.jpg)
...
![The RAG pipeline — from question to answer](/assets/issue-2/4.jpg)
...
![Without RAG vs With RAG — same model, different results](/assets/issue-2/5.jpg)
...
![RAG powers real-world AI systems everywhere](/assets/issue-2/6.jpg)
